          ...
          {teamMembers.map((member) => (
            ...
            >
              ...
              <div className="relative h-80 overflow-hidden bg-concrete">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-charcoal/90 via-charcoal/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                  <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <a
                      href="#"
                      className="inline-flex items-center gap-2 text-sm text-copper hover:text-copper-light transition-colors duration-300"
                    >
                      <Linkedin size={18} />
              ...
              <div className="p-6 border-t border-concrete group-hover:border-copper/30 transition-colors duration-300">
                <h5 className="text-xl font-medium text-charcoal mb-2 group-hover:text-copper transition-colors duration-300">
                  {member.name}
                </h5>
                <p className="text-sm text-copper tracking-wider uppercase mb-3">
                  {member.role}
                </p>

                {/* Bio for mobile */}
                <p className="text-charcoal/70 text-sm leading-relaxed md:hidden">
                  {member.bio}
                </p>
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-sm text-charcoal/60 hover:text-copper transition-colors duration-300 md:hidden mt-3"
                >
                  <Linkedin size={16} />
                  <span>Connect</span>
                </a>
        ...
        <div className="mt-20 pt-12 border-t border-concrete">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="fade-in">
              ...
              <h4 className="text-charcoal mb-3">Expert Leadership</h4>
            ...
            <div className="fade-in" style={{ animationDelay: "100ms" }}>
              ...
              <h4 className="text-charcoal mb-3">Sustainable Focus</h4>
              <p className="text-sm text-charcoal/70">
            ...
            <div className="fade-in" style={{ animationDelay: "200ms" }}>
              ...
              <h4 className="text-charcoal mb-3">Cultural Excellence</h4>
              <p className="text-sm text-charcoal/70">
