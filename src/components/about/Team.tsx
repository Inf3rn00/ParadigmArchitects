  ...
  const teamMembers = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1539618450343-13bc2c60ca45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBhcmNoaXRlY3QlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NjM1Njg1Mjd8MA&ixlib=rb-4.1.0&q=80&w=1080",
    },
    {
      id: 2,
      name: "David Chen",
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            architectural excellence and a commitment to creating meaningful,
            lasting impact.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member) => (
            <div key={member.id} className="group bg-white overflow-hidden">
              {/* Image */}
              ...
              {/* Info */}
              <div className="p-6">
                <h5 className="text-[var(--color-charcoal)] mb-1">
                  {member.name}
                </h5>
