...
export function FeaturedWorks({ onViewAll }: FeaturedWorksProps) {
  const projects = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1744148621897-5fb0b6323543?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25jcmV0ZSUyMGFyY2hpdGVjdHVyZSUyMG1pbmltYWxpc3R8ZW58MXx8fHwxNzYzNTkzMjkzfDA&ixlib=rb-4.1.0&q=80&w=1080',
      height: 'short',
    },
    {
      id: 6,
    ...
    <section className="py-24 bg-[var(--color-silver)]">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-[var(--color-charcoal)] mb-2">Featured Works</h2>
            <p className="text-gray-600">Showcasing excellence in architectural design</p>
          </div>
          <button
            onClick={onViewAll}
